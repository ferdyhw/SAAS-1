...
<body>
	...
	<fieldset>
		...
		<table>
			...
			<td>:</td>
			<td>
			<?php $jenis_kelamin = $swa['jenis_kelamin'] ?>
			<input type="radio" name="jenis-kelamin" size="30" value="Laki-Laki" required <?php echo ($jenis_kelamin == 'laki-laki') ? "checked": "" ?>>Laki-Laki
			<input type="radio" name="jenis-kelamin" size="30" value="Perempuan" required <?php echo ($jenis_kelamin == 'perempuan') ? "checked": "" ?>>Perempuan
			</td>
			</tr>
			...
			<td>:</td>
			<td>
			<?php $goldar = $swa['golongan_darah'] ?>
			<input type="radio" name="golongan-darah" size="30" value="A" required <?php echo ($goldar == 'a') ? "checked": "" ?>>A
			<input type="radio" name="golongan-darah" size="30" value="B" required <?php echo ($goldar == 'b') ? "checked": "" ?>>B
			<input type="radio" name="golongan-darah" size="30" value="O" required <?php echo ($goldar == 'o') ? "checked": "" ?>>O
			<input type="radio" name="golongan-darah" size="30" value="AB" required <?php echo ($goldar == 'ab') ? "checked": "" ?>>AB
			</td>
			</tr>
			...
			<td>
			<?php $agama = $swa['agama'] ?>
			<input type="radio" name="agama1" size="30" value="islam" required <?php echo ($agama == 'islam') ? "checked": "" ?>>Islam
			<input type="radio" name="agama1" size="30" value="protestan" required <?php echo ($agama == 'protestan') ? "checked": "" ?>>Protestan
			<input type="radio" name="agama1" size="30" value="katholik" required <?php echo ($agama == 'katholik') ? "checked": "" ?>>Katholik
			<input type="radio" name="agama1" size="30" value="hindhu" required <?php echo ($agama == 'hindhu') ? "checked": "" ?>>Hindu
			<input type="radio" name="agama1" size="30" value="budha" required <?php echo ($agama == 'budha') ? "checked": "" ?>>Budha
			</td>
			</tr>
			...
			<td>FOTO SISWA</td>
			<td>:</td>
			<td><input type="file" name="foto" value="<?= $swa['foto']?>"></input></td>
			</tr>
		...
		<table>
			...
			<td>:</td>
			<td>
			<?php $agama = $swa['agama_ayah'] ?>
			<input type="radio" name="agama2" size="30" value="islam" required <?php echo ($agama == 'islam') ? "checked": "" ?>>Islam
			<input type="radio" name="agama2" size="30" value="protestan" required <?php echo ($agama == 'protestan') ? "checked": "" ?>>Protestan
			<input type="radio" name="agama2" size="30" value="katholik" required <?php echo ($agama == 'katholik') ? "checked": "" ?>>Katholik
			<input type="radio" name="agama2" size="30" value="hindhu" required <?php echo ($agama == 'hindhu') ? "checked": "" ?>>Hindu
			<input type="radio" name="agama2" size="30" value="budha" required <?php echo ($agama == 'budha') ? "checked": "" ?>>Budha
			</td>
			</tr>
			...
			<td>
			<?php $agama = $swa['agama_ayah'] ?>
			<input type="radio" name="agama4" size="30" value="islam" required <?php echo ($agama == 'islam') ? "checked": "" ?>>Islam
			<input type="radio" name="agama4" size="30" value="protestan" required <?php echo ($agama == 'protestan') ? "checked": "" ?>>Protestan
			<input type="radio" name="agama4" size="30" value="katholik" required <?php echo ($agama == 'katholik') ? "checked": "" ?>>Katholik
			<input type="radio" name="agama4" size="30" value="hindhu" required <?php echo ($agama == 'hindhu') ? "checked": "" ?>>Hindu
			<input type="radio" name="agama4" size="30" value="budha" required <?php echo ($agama == 'budha') ? "checked": "" ?>>Budha
			</td>
			</tr>
			...
			<td>
			<?php $agama = $swa['agama_ayah'] ?>
			<input type="radio" name="agama5" size="30" value="islam" required <?php echo ($agama == 'islam') ? "checked": "" ?>>Islam
			<input type="radio" name="agama5" size="30" value="protestan" required <?php echo ($agama == 'protestan') ? "checked": "" ?>>Protestan
			<input type="radio" name="agama5" size="30" value="katholik" required <?php echo ($agama == 'katholik') ? "checked": "" ?>>Katholik
			<input type="radio" name="agama5" size="30" value="hindhu" required <?php echo ($agama == 'hindhu') ? "checked": "" ?>>Hindu
			<input type="radio" name="agama5" size="30" value="budha" required <?php echo ($agama == 'budha') ? "checked": "" ?>>Budha
			</td>
			</tr>
